...
EmployeeManagementResponse employeeManagementResponseFromJson(String str) => EmployeeManagementResponse.fromJson(json.decode(str));

String employeeManagementResponseToJson(EmployeeManagementResponse data) => json.encode(data.toJson());
